...
Thank you for considering contributing to Box! As an open source project 
...
- Open an [Issue](https://github.com/cartel-sh/lens-box/issues/new).
...
- Perform a search in [GitHub](https://github.com/cartel-sh/lens-box/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc), or the
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/cartel-sh/lens-box/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc).
...
1. Choose an issue from the [GitHub issues](https://github.com/cartel-sh/lens-box/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc), ask a member of the team
...
4. We do not enforce a commit style like
   ...
   or the body of the commit message. See [Commits](https://github.com/cartel-sh/lens-box/commits/master) for example
   commits.
