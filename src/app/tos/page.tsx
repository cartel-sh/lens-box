...
export const metadata: Metadata = {
  ...
  description: "Box terms of service",
  openGraph: {
    title: "Terms of Service",
    description: "Box terms of service",
    images: [
  ...
  return (
    <>
      <div className="prose dark:prose-invert p-8 lg:prose-lg">
        ...
        <p>By using Box, you agree to comply with the following legally binding terms and conditions:</p>
        ...
        <p>
          ...
          carefully, we emphasize that Box operates in a permissionless environment, and we cannot remove or
